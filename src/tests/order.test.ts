  ...
  it('post order - fields validation', async () => {
    ...
    expect(body.errors).toEqual(
      expect.arrayContaining([
        { error: 'Zły format', name: 'firstname' },
        { error: 'Zły format', name: 'surname' },
        { error: 'Zły format', name: 'phoneNumber' },
        { error: 'Zły format', name: 'cakeType' },
        { error: 'Zły format', name: 'cakeFlavour' },
        { error: 'Zły format', name: 'spongeColour' },
        { error: 'Nieprawidłowa wartość', name: 'cakeWeight' },
        { error: 'Zły format', name: 'cakeShape' },
        { error: 'Zły format', name: 'alcoholAllowed' },
      ]),
    );
  });
